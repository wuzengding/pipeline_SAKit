...
rule run_toi_list:
    ...
    output:
        toi_list = os.path.join(outpath,"results/FinalResults/{0}_toi_list.tsv".format(SampleID)),
        pbsv_result = os.path.join(outpath,"results/FinalResults/{0}_pbsv_results.tsv".format(SampleID))
    ...
    log:
        os.path.join(outpath,"log/run_toi_list.log")
