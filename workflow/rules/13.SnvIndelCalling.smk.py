rule SnvIndelCalling:
    ...
    params:
        ...
        af_cutoff = 0.001,
        prefix = "results/08.SvInDelSnvCalling/{0}.single_variant".format(SampleID)
    threads:
        40
    log:    
    ...
    shell:
        """
        /usr/bin/java -jar -Xmx20g {params.varcallpath}/lib/VarDict-1.8.3.jar -G {params.genome} -f {params.af_cutoff} -N {SampleID} -b {input[0]} -U -c 1 -S 2 -E 3 -g 4 {params.bedfile} -th 40|\
