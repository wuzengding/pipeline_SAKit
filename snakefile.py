...
configfile: "/mnt/data2/wuzengding/05.pipeline_dev/pipeline_SAKit_v1.0/config/sample.yml"
...
rule all:
    input:
        ## Isoform  outputs
        sqanti3_classification_final_results = os.path.join(outpath,"results/05.Isoform_Novel/{0}_isoform_classification_final_results.tsv".format(SampleID)),
        sqanti3_classification_filtered_out = os.path.join(outpath,"results/05.Isoform_Novel/{0}_isoform_classification_filtered_out_isoforms_results.tsv".format(SampleID)),

        ## Fusion outputs
        fusion_class_fusionhub = os.path.join(outpath,"results/07.Fusion_annot/{0}.fusion_classification_final_results_fusionhub.tsv".format(SampleID)),
